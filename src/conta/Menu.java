...
public class Menu {
	...
	public static void main(String[] args) {
		...
		ContaPoupanca cp2 = new ContaPoupanca(contas.gerarNumero(), 125, 2, "Juliana dos Santos", 8000f, 15);
        ...
        case 1:
        	...
        	switch(tipo) {
		        	...
		        	case 2 -> {
		        		System.out.println("Digite o dia de anivesário da conta: ");
        ...
        case 4:
        	...
        	if(buscaConta != null) {
        		...
        		switch(tipo) {
        			...
        			case 2 -> {
        				System.out.println("Digite o anversário da conta: ");
        				aniversario = leia.nextInt();
        ...
        case 8:
        	...
        	numero = leia.nextInt();
        	System.out.println("Digite o número da Destino: ");
	   ...
	   public static void sobre() {
		   ...
		   System.out.println("github.com/HiagoSant223");
		   System.out.println("********************************************");
	   }
